...
let dataDefault = [
	[
		...
		"x": 2,
		"y": 0,
		"content": "<div class=\"block\"><a class=\"align-items-center justify-content-center text-center\" href=\"\"><div><img class=\"img-icon\" src=\"img/index/icon-address.svg\" alt=\"\"><h4>HYCU <br>동문연락처 업데이트</h4></div></a></div>"
		},
		{
		"x": 3,
		"y": 0,
		...
		"x": 5,
		"y": 1,
		"content": "<div class=\"block block-c1\"><a href=\"\"><h4><small>대학생활</small><span>24시간 <br>증명서 발급센터</span></h4><i class=\"icon-block-print\"></i></a></div>"
		},
		{
		"x": 1,
		"y": 2,
